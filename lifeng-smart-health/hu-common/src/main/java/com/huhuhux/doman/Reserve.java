...
public class Reserve implements Serializable{
    ...
    public Reserve(Integer memberId, Date orderDate, String orderType, String orderStatus, Integer setmealId) {
    ...
    public Reserve(Integer id, Integer memberId, Date orderDate, String orderType, String orderStatus, Integer setmealId) {
        this.id = id;
        this.memberId = memberId;
        this.orderDate = orderDate;
        this.orderType = orderType;
